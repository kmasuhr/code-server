...
#chmod +x "velero-v${VELERO_VERSION}-linux-amdm64/velero"
...
#chmod +x "argocd-linux-adm64" && mv argocd-linux-amd64 /usr/local/bin/argocd
...
tar -xvzf "doctl-${DOCTL_VERSION}-linux-amd64.tar.gz"
